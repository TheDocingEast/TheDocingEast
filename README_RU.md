...
Студент, который строит ML-системы и desktop-инструменты — не для галочки, а потому что интересно. Нахожусь в Риге, двигаюсь в сторону DevOps/MLOps, и считаю что хорошая инфраструктура — та, которую не замечаешь.

Строю вещи, которые работают стабильно — инфраструктуру, ML-пайплайны, desktop-инструменты, и иногда системы, которые по-хорошему не должны существовать, но существуют. По кайфу интереснее всего: ML/AI системы с реальной архитектурой за ними, и desktop-инструменты, сделанные так, будто их автор сам ими пользуется.
...
Учу японский через иммерсию по методологии MoeWay — где-то между стабильным и одержимым.
3D-печать механических моделей.
Airsoft и milsim с русскоязычной командой — тактика, координация, снаряжение которое реально работает.
