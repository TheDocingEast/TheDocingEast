...
Студент, стремящийся к ML-системам и desktop-инструменты, просто ради интереса. Нахожусь в <->, двигаюсь в сторону DevOps/MLOps, и считаю что хорошая инфраструктура - та, которую не замечаешь.
Строю вещи (ага конечно), которые расчитаны на стабильность - инфраструктуру, ML-пайплайны, desktop-инструменты, и иногда, то, чего по-хорошему не должно быть. По кайфу: ML/AI системы, и desktop-инструменты, сделанные, чтобы их автор сам ими пользовался.
...
[![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:thedocingwork@gmail.com)
[![Reddit](https://img.shields.io/badge/Reddit-%23FF4500.svg?logo=Reddit&logoColor=white)](https://reddit.com/user/u/MrDoc79)
[![Twitch](https://img.shields.io/badge/Twitch-%239146FF.svg?logo=Twitch&logoColor=white)](https://twitch.tv/thedocingeast)
[![YouTube](https://img.shields.io/badge/YouTube-%23FF0000.svg?logo=YouTube&logoColor=white)](https://youtube.com/@thedocingeast)
[![Portfolio](https://img.shields.io/badge/Portfolio-%23000000.svg?style=flat&logo=firefox&logoColor=#FF7139)](https://www.thedocingeast.space)
...
Учу японский, где-то между стабильным и одержимым.
3D-печать моделек, может иногда моделирую.
Airsoft и milsim с русскоязычной командой - обожаю оружие, что не причиняет смертельную боль. Ненавижу убийства (в ирл), а если ещё и по чьей-то указке, то указчик сам умрёт, принципы есть всё.
Мечтаю о доме в дали от людей, лишь Я, ПК и чашечка кофе.
